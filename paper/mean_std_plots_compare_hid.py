...
plt.rcParams['figure.figsize'] = (FULL_PAGE_WIDTH, 2.0)  # (2.5, 2.0) 7.5， 4
...
def main():
    ...
    plt.savefig(os.path.join(os.getcwd(), f'../final_plots/quads_compare_hidden_size.pdf'), format='pdf', bbox_inches='tight', pad_inches=0.01)
